...
[NOTE]
====
This automation was specifically tested with OCP 4.10 and 4.11. Older or newer versions may have API incompatibilities or different Operator Catalog that will break the automation.
====
